...
int main(){
    ...
    switch (cod){
        case 1:
            ...
            printf("Seu novo salario, apos um aumento de 50 por cento eh igual a: %f", salario);
        break;

        case 2:
            printf("Voce eh secretario e recebe %f por mes. \n", salario);
            salario = salario + (salario * 0.35);
            printf("Seu novo salario, apos um aumento de 35 por cento eh igual a: %f", salario);
        break;

        case 3:
            printf("Voce eh caixa e recebe %f por mes \n", salario);
            salario = salario + (salario * 0.20);
            printf("Seu novo salario, apos um aumento de 20 por cento eh igual a: %f", salario);
        break;
        ...
        case 5:
            printf("Voce eh direto e recebe %f por mes \n", salario);
